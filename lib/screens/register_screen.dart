...
class RegisterScreen extends StatelessWidget {
  ...
  // TODO FALTA COMPROBACION DE SI LA CUENTA YA EXISTE CON EL SPLASH SCREEN
  // TODO CORREGIR ERROR AL SUBIR EL TECLADO
...
class _ElevatedButton extends StatelessWidget {
    ...
    return ElevatedButton(
      onPressed: () async {
        ...
        if(errorMessage == null){
          _createUserFB(email: authProvider.email, name: authProvider.name, role: authProvider.dropDownItem); // Crea la coleccion en firebase
  ...
  Future _createUserFB({
    ...
    final newUser = FirebaseFirestore.instance.collection(email).doc('info');
    // Generate the json
